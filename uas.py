...
cursor.execute("""INSERT INTO penjahit (nama_penjahit,telp_penjahit) VALUES 
               ...
               """)
cursor.execute("""INSERT INTO baju (id_user,id_penjahit,panjang_lengan,lingkar_pinggang,lingkar_dada,lebar_bahu,lingkar_pinggul,panjang_baju,tanggal_pesan,tanggal_ambil,harga) VALUES 
               ('1','1','72','80','90','55','75','102','2025-10-11','2025-10-12',200000),
               ('2','1','79','76','98','64','77','98','2025-10-11','2025-10-12',200000),
               ('3','1','75','87','88','70','85','99','2025-10-11','2025-10-12',200000),
               ('4','2','70','79','89','61','80','100','2025-10-11','2025-10-12',200000),
               ('5','2','67','86','99','65','90','90','2025-10-11','2025-10-12',200000)
               """)
connection.commit()
connection.close()