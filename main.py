...
class MainWindow(QMainWindow):
    ...
    def pelanggan(self):
        ...
        self.model_pelanggan.setHeaderData(0, Qt.Orientation.Horizontal, "Pelanggan (ID)")
        self.model_pelanggan.setHeaderData(1, Qt.Orientation.Horizontal, "Nama Pelanggan")
        self.model_pelanggan.setHeaderData(2, Qt.Orientation.Horizontal, "Alamat Pelanggan")
        self.model_pelanggan.setHeaderData(3, Qt.Orientation.Horizontal, "No Telepon Pelanggan")
    ...
    def penjahit(self):
        ...
        self.model_penjahit.setHeaderData(0, Qt.Orientation.Horizontal, "Penjahit (ID)")
        self.model_penjahit.setHeaderData(1, Qt.Orientation.Horizontal, "Nama Penjahit")
        self.model_penjahit.setHeaderData(2, Qt.Orientation.Horizontal, "No Telepon Pelanggan")
